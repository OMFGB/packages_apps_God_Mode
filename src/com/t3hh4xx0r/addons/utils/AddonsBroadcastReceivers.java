...
public class AddonsBroadcastReceivers extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
           Constants.LOCAL_FILE = "/sdcard/t3hh4xx0r/downloads/" + Constants.ADDONS;
   	   Slog.d(TAG, "Received");
	   downloadAddons(context);
	}

	private void downloadAddons(Context context) {
   ...
   public void getAddonsValues() {
	...
	if (!Constants.LOCAL_MD5.equals(Constants.REMOTE_MD5)) {
	    ...
	    Slog.d(TAG, "Your Addons are up to date.");
	}
    ...
    public void alertUser(Context context) {
        Slog.d(TAG, "You have new Addons.");
		 ...
		 CharSequence contentText = "New Addons available.";      // expanded message text

		 Intent notificationIntent = new Intent(context, com.t3hh4xx0r.addons.OMFGBAddonsActivity.class);
