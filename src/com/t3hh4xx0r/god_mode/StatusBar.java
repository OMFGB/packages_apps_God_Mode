...
public class StatusBar extends PreferenceActivity implements OnPreferenceChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // /* Battery type */
        // mBatteryOption = (ListPreference)
        // prefSet.findPreference(BATTERY_OPTION);
        // batteryStyleVal = Settings.System.getInt(getContentResolver(),
        // Settings.System.BATTERY_OPTION, 1);
        // mBatteryOption.setValue(String.valueOf(batteryStyleVal));
        // mBatteryOption.setOnPreferenceChangeListener(this);
        //
        // /* Clock style */
        // mClockStyle = (ListPreference)
        // prefSet.findPreference(STATUSBAR_CLOCK_OPT);
        // clockStyleVal =
        // Settings.System.getInt(getContentResolver(),Settings.System.STATUSBAR_CLOCK_OPT,
        // 0);
        ...
        // mHideBluetooth = (CheckBoxPreference)
        // prefSet.findPreference(HIDE_BLUETOOTH);
        ...
        // mHideSignal = (CheckBoxPreference)
        // prefSet.findPreference(HIDE_SIGNAL_ICON);
        // mHideSignal.setChecked(Settings.System.getInt(getContentResolver(),
        // Settings.System.HIDE_SIGNAL_ICON, 0) == 1);
        //
        // /* Show or hide battery percentages */
        // mBatteryPercent = (CheckBoxPreference)
        // prefSet.findPreference(STATUSBAR_BATTERY_PERCENT);
        // mBatteryPercent.setChecked(Settings.System.getInt(getContentResolver(),
        // Settings.System.STATUSBAR_BATTERY_PERCENT, 0) == 1);
        //
        // /* Show or hide the battery icon */
        // mHideBattery = (CheckBoxPreference)
        // prefSet.findPreference(STATUSBAR_HIDE_BATTERY);
        // mHideBattery.setChecked(Settings.System.getInt(getContentResolver(),
        // Settings.System.STATUSBAR_HIDE_BATTERY, 0) == 1);
        //
        // /* Show or hide the alarm icon */
        // mHideAlarm = (CheckBoxPreference)
        // prefSet.findPreference(STATUSBAR_HIDE_ALARM);
        // mHideAlarm.setChecked(Settings.System.getInt(getContentResolver(),
        // Settings.System.STATUSBAR_HIDE_ALARM, 0) == 1);
        //
        // /* Setting for clock color */
        // mClockColor = (Preference)
        // prefSet.findPreference(STATUSBAR_CLOCK_COLOR);
        //
        // /* Setting for hiding USB debugging icon */
        // mAdbNotify = (CheckBoxPreference) findPreference(ADB_NOTIFY);
        // mAdbNotify.setChecked(Settings.Secure.getInt(getContentResolver(),Settings.Secure.ADB_NOTIFY,
        // 0) == 1);
        //
        // /* Setting for miui battery color */
        // mMiuiBatteryColor = (Preference)
        // prefSet.findPreference(MIUI_BATTERY_COLOR);
        //
        // /* StatusBar date setting */
        // mDateClock = (ListPreference)
        // prefSet.findPreference(STATUSBAR_DATECLOCK);
        ...
        // mBatteryTextOptions = (PreferenceScreen)
        // prefSet.findPreference(BATTERY_TEXT_OPTIONS);
        //
        // /* Carrier cap setting */
        // mCarrierCaption = (EditTextPreference)
        // prefSet.findPreference(CARRIER_CAP);
        // mCarrierCaption.setOnPreferenceChangeListener(new
        ...
        // mPowerPicker = (PreferenceScreen)
        // prefSet.findPreference(UI_EXP_WIDGET_PICKER);
        // mPowerOrder = (PreferenceScreen)
        // prefSet.findPreference(UI_EXP_WIDGET_ORDER);
    }
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        // Settings.System.STATUSBAR_SHOW_SIGNAL_ICON, mHideSignal.isChecked() ?
        // 1 : 0);
        // }
        // if (preference == mHideBluetooth) {
        // Settings.System.putInt(getContentResolver(),
        // Settings.System.HIDE_BLUETOOTH, mHideBluetooth.isChecked() ? 1 : 0);
        // }
        // if (preference == mHideWifi) {
        // Settings.System.putInt(getContentResolver(),
        // Settings.System.HIDE_WIFI, mHideWifi.isChecked() ? 1 : 0);
        // }
        // if (preference == mHideClock) {
        // Settings.System.putInt(getContentResolver(),
        // Settings.System.HIDE_CLOCK, mHideClock.isChecked() ? 0 : 1);
        // updateStylePrefs();
        // }
        // if (preference == mHideDate) {
        // Settings.System.putInt(getContentResolver(),
        // Settings.System.HIDE_DATE, mHideDate.isChecked() ? 0 : 1);
        // updateStylePrefs();
        // }
        // if (preference == mAdbNotify) {
        // Settings.Secure.putInt(getContentResolver(),
        // Settings.Secure.ADB_NOTIFY, mAdbNotify.isChecked() ? 0 : 1);
        // }
        // if (preference == mBatteryPercent) {
        // Settings.System.putInt(getContentResolver(),
        // Settings.System.STATUSBAR_BATTERY_PERCENT,
        // mBatteryPercent.isChecked() ? 1 : 0);
        // }
        // if (preference == mHideBattery) {
        // Settings.System.putInt(getContentResolver(),
        // Settings.System.STATUSBAR_SHOW_BATTERY_ICON, mHideBattery.isChecked()
        // ? 1 : 0);
        // }
        // if (preference == mHideAlarm) {
        // Settings.System.putInt(getContentResolver(),
        // Settings.System.STATUSBAR_HIDE_ALARM, mHideAlarm.isChecked() ? 1 :
        // 0);
        // }
    ...
    public boolean onPreferenceChange(Preference preference, Object objValue) {
        ...
        // Settings.System.putInt(getContentResolver(),
        // Settings.System.BATTERY_OPTION, Integer.valueOf((String) objValue));
        // checkMiuiBattery(batteryStyleVal);
        // return true;
        // } else if (preference == mDateClock) {
        // dateStyleVal = Integer.valueOf((String) objValue);
        // Settings.System.putInt(getContentResolver(),
        // Settings.System.STATUSBAR_DATECLOCK, Integer.valueOf((String)
        // objValue));
        // updateStylePrefs();
        // return true;
        ...
        // Settings.System.putInt(getContentResolver(),
        // Settings.System.STATUSBAR_CLOCK_OPT, clockStyleVal );
        // updateStylePrefs();
        // return true;
        // }
        return false;
